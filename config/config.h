...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-6.9.1/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed */
#define LIBRARY_RELATIVE_PATH "ImageMagick-6.9.1"
...
#define PACKAGE_STRING "ImageMagick 6.9.1-0"
...
#define PACKAGE_VERSION "6.9.1-0"
